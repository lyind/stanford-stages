...
def serialize_anl(out_file, stages, starttime_seconds, epoch_duration_millies, colors=None):
    ...
    for epoch_stage in stages:
        ...
        out_file.write(serializer.pack(timestamp_us, 0, colors[stage], 0, stage, 0))
